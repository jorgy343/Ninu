namespace Ninu.Emulator
{
    ...
    /// </summary>
    public interface ICpuBusComponent
    {
        /// <summary>
        /// Attempts to handle a read operation on the bus. If the address is within the component's addressable range,
        /// the read is performed and this method returns true. If the address is outside of the addressable range,
        /// this method returns false and the next component on the bus gets a chance to handle the read.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to handle a write operation on the bus. If the address is within the component's addressable
        /// range, the write is performed and this method returns true. if the address is outside of the addressable
        /// range, this method returns false and the next component on the bus gets a change to handle the write.
        /// </summary>
